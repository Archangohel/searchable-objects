 ...
 * searchable entity(Class having {@link Searchable} annotation). It will use the return type and update that to index
 *
 * @auther Archan on 23/11/17.
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
public @interface UpdateToIndexAfterExecution {
}
